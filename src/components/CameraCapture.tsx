  ...
  return (
    <div className="glass-panel rounded-3xl p-4 sm:p-8 animate-fade-in-up">
      ...
      <div className="space-y-4 sm:space-y-6">
        {isTextMode ? (
          <div className="bg-white rounded-3xl p-6 shadow-inner border border-slate-200 min-h-[300px] flex flex-col">
            ...
            <textarea
              ...
              className="w-full flex-1 p-4 rounded-xl border border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none resize-none text-slate-700 placeholder:text-slate-400"
            />
          </div>
        ) : (
          <>
